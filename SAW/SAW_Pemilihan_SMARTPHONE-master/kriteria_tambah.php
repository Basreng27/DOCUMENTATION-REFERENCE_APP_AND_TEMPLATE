                ...
                <div class="col-md-6">
                    <div class="panel panel-default">
                            ...
                            <form action="kriteria_tambah.php" method="post" name="form1">
                                <table width="25%" border="0">
                                    <div class="form-group">
                                        <label>ID</label>
                                        <input type="text" class="form-control" name="id" placeholder="Nama Kriteria" />
                                    </div>
                                    <div class="form-group">
                        ...
                        if (isset($_POST['Submit'])) {
                            ...
                            $result = mysqli_query($connect, "INSERT INTO kriteria VALUES('$id','$name','$att')") or die(mysqli_error($connect));
