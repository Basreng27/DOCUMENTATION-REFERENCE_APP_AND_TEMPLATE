                    ...
                    <div class="col-md-16">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                $aksi = @$_GET['aksi'];
                                if (($aksi <> "") and ($id_sub <> "")) {
                                    mysqli_query($connect, "delete from subkriteria where id_sub='$id_sub'") or die(mysqli_error());
                                ...
                                <div class="datatable table-responsive">
                                    <table class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            include "koneksi.php";
                                            $nomor = 0;
                                            $result = mysqli_query($connect, "SELECT * FROM subkriteria, kriteria WHERE subkriteria.id_kriteria=kriteria.id_kriteria order by subkriteria.id_sub asc") or die(mysqli_error());
