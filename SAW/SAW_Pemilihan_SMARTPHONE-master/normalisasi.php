                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                if (($aksi <> "") and ($id_normal <> "")) {
                                    mysqli_query($connect, "delete from normal where id_normal='$id_normal'") or die(mysql_error());
                                ...
                                <div class="datatable table-responsive">
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            include "koneksi.php";
                                            $nomor = 0;
                                            $result = mysqli_query($connect, "SELECT * FROM normal, alternatifhp WHERE normal.idhp=alternatifhp.idhp") or die(mysqli_error());
