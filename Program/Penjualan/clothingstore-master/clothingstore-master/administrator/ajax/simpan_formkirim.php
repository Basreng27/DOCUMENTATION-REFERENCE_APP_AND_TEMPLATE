<?php 
	...
	$query_formkirim = "INSERT INTO tbl_datapengiriman (no_resi, jasa_kirim, tgl_kirim, lama_kirim, catatan_kirim, tgl_record, no_penjualan, id_pgw) VALUES ('$no_resi', '$jasa_kirim', '$tgl_kirim', '$lama_pengiriman', '$catatan_kirim', CURDATE(), '$no_penjualan', '$id_pgw')";
