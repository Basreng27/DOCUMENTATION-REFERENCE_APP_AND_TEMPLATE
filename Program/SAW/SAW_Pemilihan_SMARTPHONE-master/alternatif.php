                    ...
                    <div class="col-md-6">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                ...
                                $aksi = @$_GET['aksi'];
                                if (($aksi <> "") and ($id <> "")) {
                                    mysqli_query($connect, "delete from alternatifhp where idhp='$id'") or die(mysqli_error());
                                    echo "<script type=text/javascript>
                                window.location.href='http://localhost/SAW_Pemilihan_SMARTPHONE-master/alternatif.php';
                                </script>";
                                }
                                ?>
                            </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <?php
                                            include "koneksi.php";
                                            $result = mysqli_query($connect, "SELECT * FROM alternatifhp") or die(mysqli_error());
